...
# Prepare SSH keys if needed
echo "Preparing SSH keys for container build..."
bash docker/prepare_ssh_keys.sh
...
docker build -t ai-container-image -f docker/Dockerfile.container docker/
